  ...
  return (
    <section className="w-full bg-white py-20 px-4 md:px-16 lg:px-32 text-gray-800">
      <div className="max-w-5xl mx-auto">
        ...
        <p className="text-lg leading-relaxed mb-6">
          By visiting this Website you agree to be bound by the terms and conditions of this Privacy
        ...
        <p className="text-lg leading-relaxed mb-6">
          When you use our Website, we collect and store your personal information which is provided
          by you from time to time. Our primary goal in doing so is to provide you a safe, efficient,
          smooth and customized experience. This allows us to provide services and features that most
          likely meet your needs, and to customize our Website to make your experience safer and
          easier. More importantly, while doing so we collect personal information from you that we
        ...
        <p className="text-lg leading-relaxed mb-6">
          ...
          are optional. You always have the option to not provide information by choosing not to use a
        ...
        <p className="text-lg leading-relaxed mb-6">
          ...
          personal information to market to you, we will provide you the ability to opt-out of such
          uses. We use your personal information to resolve disputes; troubleshoot problems; help
          promote a safe service; collect money; measure consumer interest in our products and
          services; inform you about online and offline offers, products, services, and updates;
        ...
        <h2 className="text-2xl font-semibold mt-10 mb-4">3. Sharing of Personal Information</h2>
        <p className="text-lg leading-relaxed mb-6">
        ...
        <h2 className="text-2xl font-semibold mt-10 mb-4">4. Advertisements</h2>
        <p className="text-lg leading-relaxed mb-6">
